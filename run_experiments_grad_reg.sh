...
do
	...
	do
		...
		CUDA_VISIBLE_DEVICES=1 python3 -W ignore main.py --model baseline  --data mnist --epoch_classifier 80  --epoch_finetune 20  --bs 250  --seed $seed --use_cuda --early_stopping 
		CUDA_VISIBLE_DEVICES=1 python3 -W ignore main.py --model tbaseline  --data mnist --epoch_classifier 80  --epoch_finetune 20  --bs 250  --seed $seed --use_cuda --early_stopping 
		CUDA_VISIBLE_DEVICES=1 python3 -W ignore main.py --model goodfellow  --data mnist --epoch_classifier 80  --epoch_finetune 20  --bs 250  --seed $seed --use_cuda --early_stopping 
		CUDA_VISIBLE_DEVICES=1 python3 -W ignore main.py --model GI  --data mnist --epoch_classifier 80  --epoch_finetune 20  --bs 250  --seed $seed --use_cuda --early_stopping --goodfellow		
