...
def load_moons(domains, root='../../data'):
	...
	np.save("{}/X.npy".format(processed_folder), np.concatenate(X_data), allow_pickle=True)
	np.save("{}/Y.npy".format(processed_folder), np.concatenate(Y_data), allow_pickle=True)
	np.save("{}/A.npy".format(processed_folder), np.concatenate(A_data), allow_pickle=True)
	np.save("{}/U.npy".format(processed_folder), np.concatenate(U_data), allow_pickle=True)
